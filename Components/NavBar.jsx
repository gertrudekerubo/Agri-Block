...
import { Nav2, Nav1, Nav3 } from "."; // Assuming Nav1 and Nav3 are components from "./" directory
...
const NavBar = () => {
    ...
    const navigation = [
        { title: "Home", path: "#" },
        { title: "Services", path: "#" },
        { title: "Contact Us", path: "#" }, // Corrected typo in path attribute
        { title: "Erc20", path: "#" }, // Corrected capitalization of "Path" to "path"
    ];
                ...
                <div className="flex items-center justify-between py-5 md:block">
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            onClick={() => setState(!state)} // Corrected "onclick" to "onClick"
                        >
                            {state ? <Nav1 /> : <Nav2 />} {/* Changed Nav1 to Nav2 */}
                        </button>
                    </div>
                </div>
