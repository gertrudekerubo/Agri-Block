...
export default ({getModel, setGetModel,getShipment}) =>{
  ...
  const converTime = (time)=>{
    ...
    const dataTime = new Intel.DateTimeFormat("en-USL ", {
        year:"numeric",
        month:"2-digit",
        day: "2-digit",
    }).format(newTime);
...
return getModel ?(
    ...
    <div className="flex items-center min-h-screen px-4 py-8">
      <div className="relative w-full max-w-lg p-4 mx-auto bg-whiterounded-md shadow-lg">
      ...
      <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
        ...
        {singleShipmentData==undefined ? (
          ...
          <div className="text-left">
            ...
            <p>
              paid:{""}
              {singleShipmentData.idPaid ? "Complete" :"Not Complete"}
            </p>
            </div>
        )}
      </div>
